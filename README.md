...
### GWO Convergence
![GWO](assets/gwo_convergence.png)
...
│   ├── README.md                    # Bu dosya
│   ├── __init__.py
│   ├── assets/                      # README görselleri (demo.gif, confusion_matrix.png vb.)
│   ├── outputs/
│   │   └── run_YYYYMMDD_HHMMSS_utc/
│   │       ├── run.log
│   │       ├── gwo_result.json
...
> **Görseller için:** `outputs/` içinden bir confusion matrix, ROC curve ve GWO convergence
> görselini `assets/` klasörüne kopyala. Demo GIF için pipeline çalışırken ekran kaydı al,
> https://ezgif.com/video-to-gif ile GIF'e çevir ve `assets/demo.gif` olarak kaydet.
...
```bash
python brain_tumor_pipeline/run_pipeline.py --max-iterations 80
```
